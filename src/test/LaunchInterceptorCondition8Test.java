...
public class LaunchInterceptorCondition8Test {
    ...
    public void notEnoughPointsTest() {
        ...
        assertFalse("LIC8 must be false if there are less than five points.", li.lic8());
    }
    ...
    public void noPointsTest() {
        ...
        assertFalse("LIC1 must be false if there are no points.", li.lic8());
    }
    ...
    public void trivialFailingTest() {
        ...
        Point[] points = { new Point(0, 0), new Point(0, 0), new Point(0, 1), new Point(0, 0), new Point(1, 0) };
    ...
    public void trivialPassingTest() {
        ...
        Point[] points = { new Point(0, 0), new Point(0, 0), new Point(0, 10), new Point(0, 0), new Point(0, -11) };
